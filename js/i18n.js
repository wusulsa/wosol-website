...
const WASUL_I18N = {
  ...
  ar: {
    ...
    live_label: 'مباشر',
    title_service_text1:'نقل منسوبي الجهات',
    sub_title_service_text1:'عقود تشغيل شهرية وسنوية',
    title_service_badge1:'نشط',
    title_service_text2:'النقل التعليمي',
    sub_title_service_text2:'جامعات ومدارس ومعاهد ومراكز تدريب',
    title_service_text3:'رحلات ومجموعات',
    sub_title_service_text3:'وفود ورحلات دينية وسياحية',
    ...
    services_subtitle: 'خبرة تشغيلية في نقل منسوبي القطاعات، النقل التعليمي، الرحلات والمجموعات، مع تجهيزات تدعم الراحة والسلامة.',
    service_1_title: 'نقل منسوبي القطاعات',
    service_1_desc: 'نقل موظفي وعمال ومنسوبي القطاعات العامة والخاصة وفق جداول وورديات ومسارات متفق عليها.',
    service_2_title: 'النقل التعليمي',
    service_2_desc: 'حلول للجامعات والمدارس والمعاهد ومراكز التدريب، بالإضافة إلى تسجيل المشتركات في المسارات الجامعية المتاحة.',
    service_3_title: 'الرحلات الدينية والسياحية',
    service_3_desc: 'نقل الزوار والمعتمرين والمجموعات والوفود بمركبات مناسبة لعدد الركاب وبرنامج الرحلة.',
  ...
  en: {
    ...
    live_label: 'Live',
    title_service_text1:'Organization Staff Transport',
    sub_title_service_text1:'Monthly and annual operating contracts',
    title_service_badge1:'Active',
    title_service_text2:'Educational Transport',
    sub_title_service_text2:'Universities, schools, institutes, and training centers',
    title_service_text3:'Trips and Groups',
    sub_title_service_text3:'Delegations, religious, and tourism trips',
    ...
    services_subtitle: 'Operational experience in staff transport, educational transport, trips, and groups, supported by practical comfort and safety equipment.',
    service_1_title: 'Sector Staff Transport',
    service_1_desc: 'Transport for employees, workers, and staff of public and private organizations according to agreed schedules, shifts, and routes.',
    service_2_title: 'Educational Transport',
    service_2_desc: 'Solutions for universities, schools, institutes, and training centers, plus direct registration for available university routes.',
    service_3_title: 'Religious and Tourism Trips',
    service_3_desc: 'Transport for visitors, pilgrims, groups, and delegations using vehicles suited to passenger count and trip program.',
